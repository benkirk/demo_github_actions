...
int main(){
  ...
  getExecutionTime("std::copy() / std::sort() / std::unique() / std::execution::seq", [ &randValues, &workVec]() {
  ...
  getExecutionTime("std::copy() / std::sort() / std::unique() / std::execution::par", [ &randValues, &workVec]() {
  ...
  getExecutionTime("std::copy() / std::sort() / std::unique() / std::execution::par_unseq", [ &randValues, &workVec]() {
