...
+CXX_STD ?=
+ARCH_FLAGS ?=
+TEST_CFLAGS = -Wall ${ARCH_FLAGS} ${DEFINES} ${INCLUDES} ${OTHER_INCLUDES}
+ARCH_CU_FLAGS ?=
+TEST_CU_CFLAGS = ${ARCH_CU_FLAGS} ${ARCH_FLAGS} ${CXX_STD} ${DEFINES} ${INCLUDES} ${OTHER_INCLUDES}
